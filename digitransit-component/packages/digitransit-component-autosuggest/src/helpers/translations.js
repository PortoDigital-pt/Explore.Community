const translations = {
  ...
  pt: {
    ...
    'add-via-duration-button-label':
      'Definir a duração da paragem no ponto via {{index}}',
    'add-via-duration-button-label-close':
      'Fechar seletor de duração de parada no ponto via {{index}}',
    'add-via-duration-button-label-open':
      'Abra o seletor de duração de parada no ponto via {{index}}',
    address: 'Endereço',
    'address-place-or-business': 'Morada, local ou empresa',
    airplane: 'Voo',
    arrival: 'Chegada',
    back: 'Voltar',
    bikepark: 'Parque e passeio de bicicleta',
    bikerentalstation: 'Estação de bicicletas',
    bus: 'ônibus',
    cancel: 'Cancelar',
    carpark: 'Parque e Passeio',
    ...
    favourite: 'Favorito',
    ferry: 'Balsa',
    'future-route': 'Rota futura',
    'give-destination': 'Introduza o seu destino',
    'give-origin': 'Introduza a sua origem.',
    loading: 'A carregar...',
    'minute-short': 'm',
    origin: 'Início',
    'origin-stop-near-you': 'Início',
    ownlocations: 'Localizações próprias',
    place: 'Localização',
    platform: 'Plataforma',
    rail: 'Comboio',
    required: 'Campo obrigatório',
    search: 'Pesquisar',
    'search-address-or-place': 'Pesquisar por endereço ou topónimo',
    'search-autosuggest-label': 'Local, local e paragem.',
    'search-autosuggest-label-instructions-desktop':
      'Navegue na lista com as setas do teclado e selecione com a tecla Enter.',
    'search-autosuggest-label-instructions-mobile':
      'Insira o local e navegue na lista passando o dedo.',
    'search-autosuggest-label-move-to-destination':
      'Depois de selecionar o local de partida, você é automaticamente movido para o campo de destino.',
    'search-autosuggest-len': 'Há {{count}} sugestão disponível',
    'search-autosuggest-len_plural': 'Existem sugestões {{count}} disponíveis',
    'search-button-label': 'Pesquisar',
    'search-current-suggestion': 'Seleção atual: {{selection}}',
    'search-destination': 'Pesquisar destino, rota ou parada',
    ...
    'select-from-map': 'Selecionar posição no mapa',
    'select-from-own-locations': 'Selecione a partir de locais próprios',
    station: 'Estação',
    stop: 'Parar',
    'stop-near-you': 'Pesquisar paragens e rotas',
    'stop-near-you-airplane': 'Procurar voos ou aeroportos',
    'stop-near-you-bus': 'Pesquisar rotas ou paradas de ônibus',
    'stop-near-you-citybike': 'Pesquisar estações de bicicleta da cidade',
    'stop-near-you-rail': 'Pesquisar rotas ou estações de trem',
    'stop-near-you-subway': 'Pesquisar rotas ou estações de metrô ',
    'stop-near-you-tram': 'Pesquisar rotas ou paradas de bonde',
    'stop-route-station': 'Busca de ônibus e paradas',
    street: 'Rua',
    subway: 'Metrô',
    'today-at': 'hoje em',
    ...
    track: 'Acompanhar',
    tram: 'Elétrico',
    'use-own-position': 'Usar a localização atual',
