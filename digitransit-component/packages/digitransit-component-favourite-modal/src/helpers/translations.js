const translations = {
  ...
  pl: {
    ...
    'favourite-modal-on-edit': 'Edycja ulubionego miejsca: {{favourite.name}}',
  ...
  pt: {
    cancel: 'Cancelar',
    'choose-icon': 'Selecionar o ícone do lugar',
    'close-favourite-modal': 'Fechar o modal de favoritos',
    'edit-place': 'Editar lugar',
    'favourite-modal-on-add-new': 'Adicionar um novo favorito',
    'favourite-modal-on-edit': 'Editar favorito: {{favourite.name}}',
    'input-placeholder': 'Definir o nome do lugar (opcional)',
    save: 'Guardar',
    'save-place': 'Guardar lugar',
    'cannot-save-place': 'Não é possível guardar um lugar sem morada ou ícone',
    place: 'um lugar',
    home: 'casa',
    work: 'trabalho',
    sport: 'desporto',
