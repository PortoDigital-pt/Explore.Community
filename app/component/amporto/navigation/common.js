...
export const COMMON_NAVIGATION_ITEMS_PATH_MAP = {
  ...
  [COMMON_NAVIGATION_ITEMS.ROUTES]: `/${COMMON_NAVIGATION_ITEMS.EXPLORE}/${COMMON_NAVIGATION_ITEMS.ROUTES}`,
  [COMMON_NAVIGATION_ITEMS.BLOCKS]: `/${COMMON_NAVIGATION_ITEMS.EXPLORE}/${COMMON_NAVIGATION_ITEMS.BLOCKS}`
};
